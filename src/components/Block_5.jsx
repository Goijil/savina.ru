export function Block_5() {
  return (
    <>
      ...
      >
        <div className="bg-Beige p-10 flex flex-col justify-between gap-5">
          <div>
            ...
            <div className="mt-5 flex flex-col gap-5 2xl:text-3xl xl:text-2xl lg:text-xl md:text-lg sm:text-base text-base">
              <div>
                ...
                <h1 className="text-center">(45 мин. 1-3 раза в неделю)</h1>
              </div>
              <div>
                <h1>
                  -Психологическое консультирование, работа с текущим состоянием
                  и ситуацией
                </h1>
              ...
              <div>
                <h1>
                  -Супервизии для начинающих коллег и специалистов, практикующих
                  в не-психоаналитических подходах
                </h1>
                <h1 className="text-center">(50 мин.)</h1>
              </div>
            </div>
          </div>
